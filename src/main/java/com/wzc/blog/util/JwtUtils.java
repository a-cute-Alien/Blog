...
public class JwtUtils {
    ...
    public static String generateToken(User userInfo, PrivateKey privateKey, int expireMinutes) throws Exception {
        return Jwts.builder()
                ...
                .claim(JwtConstans.JWT_KEY_NICK_NAME,userInfo.getNickname())
                .claim(JwtConstans.JWT_KEY_AVATAR,userInfo.getAvatar())
    ...
    public static User getInfoFromToken(String token, PublicKey publicKey) throws Exception {
        ...
        User user = new User();
        user.setId(Long.valueOf(body.get(JwtConstans.JWT_KEY_ID).toString()));
        user.setUsername(body.get(JwtConstans.JWT_KEY_USER_NAME).toString());
        user.setNickname(body.get(JwtConstans.JWT_KEY_NICK_NAME).toString());
